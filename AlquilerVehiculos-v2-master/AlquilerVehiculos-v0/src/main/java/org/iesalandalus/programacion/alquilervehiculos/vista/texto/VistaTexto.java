...
public class VistaTexto extends Vista {
	...
	public void listarClientes() {
		...
		Collections.sort(controlador.getClientes(), new Comparator<Cliente>() {
	...
	public void listarVehiculos() {
		...
		Collections.sort(controlador.getVehiculos(), new Comparator<Vehiculo>() {
	...
	public void listarAlquileres() {
		...
		Collections.sort(controlador.getAlquileres(), new Comparator<Alquiler>() {
